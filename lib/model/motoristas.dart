class Motorista {
  ...
  Motorista(this._id, this._nome, this._senha, this._email, this._nascimento, this._telefone, this._cpf, this._rg, this._endereco, this._bairro, this._cidade, this._estado, this._periodo);

  Motorista.map(dynamic obj) {
    this._id = obj['id']; 
    this._nome = obj['nome'];
  ...
  Motorista.fromMap(Map<String, dynamic> map, String id){
    this._id = id ?? '';
    this._nome = map['nome'];
